# InfraTales | Observability Stack – Full Tracing + Metrics + Logging on AWS

**Production-ready reference architecture for unified observability with OpenTelemetry on AWS.**

> **Complete observability stack with OpenTelemetry instrumentation, distributed tracing across 100+ microservices, metrics aggregation, and unified telemetry**
